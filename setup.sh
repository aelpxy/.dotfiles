...
yay -S neofetch neovim fish lsd wget curl chromium seahorse noto-fonts-emoji nodejs btop go fzf alacritty visual-studio-code-bin spotify discord zip unzip flameshot tree jq tokei whois
